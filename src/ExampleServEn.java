...
public class ExampleServEn extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        out.println("<!DOCTYPE html>"+
                ...
                "  \n" +
                "  <p class=\"question\">\n" +
                "      This is a practice question. <br><br> \n" +
                "      Please drag the fragments in order of representativeness. The fragment at the top should be the one that in your opinion gives the best idea of the entire song, the fragment at the bottom the least good idea. The symbols in front of the players can be used to distinguish the fragments. To order the fragments, drag and drop them in the desired order."+
                "      <br>The song used is:  " +
